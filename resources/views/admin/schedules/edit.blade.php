...
@section('title', 'Edit Jadwal Penerbangan - Travelasing API')
            ...
            <div class="p-3">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.schedules.update', $schedule->id_schedule) }}" method="POST">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select name="route_id" id="route_id" class="form-select @error('route_id') is-invalid @enderror" required>
                                        ...
                                        @foreach($routes as $route)
                                            <option value="{{ $route->id_route }}" {{ old('route_id', $schedule->id_route) == $route->id_route ? 'selected' : '' }}>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="datetime-local" name="depart_time" id="depart_time" class="form-control @error('depart_time') is-invalid @enderror" value="{{ old('depart_time', $schedule->depart_time->format('Y-m-d\TH:i')) }}" required>
                                    @error('depart_time')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="datetime-local" name="arrival_time" id="arrival_time" class="form-control @error('arrival_time') is-invalid @enderror" value="{{ old('arrival_time', $schedule->arrival_time->format('Y-m-d\TH:i')) }}" required>
                                    @error('arrival_time')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="available_seats" id="available_seats" class="form-control @error('available_seats') is-invalid @enderror" value="{{ old('available_seats', $schedule->available_seats) }}" min="1" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="price" id="price" class="form-control @error('price') is-invalid @enderror" value="{{ old('price', $schedule->price) }}" min="0" required>
                                    </div>
                                    @error('price')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
