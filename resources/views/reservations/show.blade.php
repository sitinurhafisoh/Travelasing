...
@section('title', 'Detalles de Reserva - Travelasing')
...
<div class="container py-4">
    <div class="row mb-4">
        <div class="col">
            ...
            <p class="lead">Información completa de tu reserva.</p>
        </div>
        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3 text-md-end">
                            ...
                            @if($reservation->status == 'Proses')
                                <h4><span class="badge bg-warning text-dark">En proceso</span></h4>
                            @elseif($reservation->status == 'Selesai')
                                <h4><span class="badge bg-success">Completado</span></h4>
                            @else
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <h6 class="text-muted">Tipo de Transporte</h6>
                    ...
                    <div class="mb-3">
                        <h6 class="text-muted">Detalles de Reserva</h6>
                        <p>{{ $reservation->reserv_desc ?: 'Sin detalles adicionales' }}</p>
                    </div>
                </div>
                <div class="card-footer bg-light d-flex justify-content-between">
                    <span>Reservado el: {{ \Carbon\Carbon::parse($reservation->created_at)->format('d/m/Y H:i') }}</span>
